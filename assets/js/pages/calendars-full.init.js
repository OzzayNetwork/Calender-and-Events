! function(g) {
    ...
    e.prototype.init = function() {
        ...
        new FullCalendarInteraction.Draggable(document.getElementById("external-events"), {
            ...
            eventData: function(e) { return { title: e.innerText, className: g(e).data("class") } }
        });
        var c = [{
                title: "AGM meeting",
        ...
        var m = new FullCalendar.Calendar(v, {
            ...
            eventClick: function(e) {
                l.modal("show"),
                    a[0].reset(), i = e.event, g(".event-title").text(i.title), g("#event-category").val(i.classNames[0]), r = null, t.text("Edit Event"), r = null,
                    g('.event-category-color').addClass(i.classNames[0]),

                    g('.event-start-date').text(i.start),
                    g('.event-end-date').text(i.end)

            },
            dateClick: function(e) { u(e) },
            events: c
        });
        ...
        }), g("#btn-new-event").on("click", function(e) { u({ date: new Date, allDay: !0 }) })
